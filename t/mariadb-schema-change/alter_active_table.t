...
sub start_query_table {
   ...
   system("$cmd 127.0.0.1 12345 $db $tbl $pkcol $query_table_stop $query_table_pid >$query_table_output &");
...
`cp $trunk/t/mariadb-schema-change/samples/basic_no_fks.data /tmp/12345/run/tmp.data`;
# $master_dbh->do("LOAD DATA INFILE '$trunk/t/mariadb-schema-change/samples/basic_no_fks.data' INTO TABLE t"); ## Original Line.
$master_dbh->do("LOAD DATA INFILE '/run/mysqld/tmp.data' INTO TABLE t");
