...
$sb->load_file('slave2', "t/mariadb-schema-change/samples/pt-1455_slave.sql");
diag("Setting replication filters on slave 1");
$sb->load_file('slave1', "t/mariadb-schema-change/samples/pt-1455_slave.sql");
diag("Setting replication filters on master");
$sb->load_file('master', "t/mariadb-schema-change/samples/pt-1455_master.sql",undef, no_wait => 1);
...
$sb->load_file('slave2', "t/mariadb-schema-change/samples/pt-1455_reset_slave.sql");
diag("Resetting replication filters on slave 1");
$sb->load_file('slave1', "t/mariadb-schema-change/samples/pt-1455_reset_slave.sql");
