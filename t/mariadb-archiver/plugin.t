...
$sb->load_file('master', 't/mariadb-archiver/samples/tables7-9.sql');
...
$sb->load_file('master', 't/mariadb-archiver/samples/table10.sql');
...
# on even/odd
$sb->load_file('master', 't/mariadb-archiver/samples/table10.sql');
$sb->load_file('master', 't/mariadb-archiver/samples/table13.sql');
