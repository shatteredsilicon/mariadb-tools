...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump003.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump001.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump012.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump002_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump017_report.txt"
   ),
   'Analysis for tcpdump017 with microsecond timestamps (issue 398)'
);

# #############################################################################
# Bug 1103045: mariadb-query-digest fails to parse non-SQL errors
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump043_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/tcpdump044_report.txt"
   ),
