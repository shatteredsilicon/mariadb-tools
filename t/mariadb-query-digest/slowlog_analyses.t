...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/empty_report.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow001_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow001_tablesreport.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow001_tablesreport_no_vertical.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow001_distillreport.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow002_distilltimeline.txt"
   ),
...
ok(
   no_diff(
      sub { pt_query_digest::main(@args, $sample.'slow002.txt') },
      "t/mariadb-query-digest/samples/slow002_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow002_report_no_vertical.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow002_report_filtered.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow002_orderbyreport.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow003_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow004_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow006_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow008_report.txt"
   ),
...
ok(
   no_diff(
      sub { pt_query_digest::main(@args, $sample.'slow010.txt',
            ...
            qw(--group-by file)) },
      "t/mariadb-query-digest/samples/slow010_reportbyfile.txt"
   ),
...
ok(
   no_diff(
       ...
       "t/mariadb-query-digest/samples/slow011_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow013_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow013_report_user.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow013_report_fingerprint_user.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow013_report_profile.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow013_report_limit.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow014_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow018_report.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow019_report.txt"
   ),
   '--zero-admin works'
);
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow023.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow024.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow002-orderbynonexistent.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow028.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow035.txt"
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow037_report.txt"
   ),
...
ok(
   no_diff(
      sub { pt_query_digest::main(@args, $sample.'slow034.txt', qw(--order-by Lock_time:sum),
            '--report-format', 'query_report,profile') },
      "t/mariadb-query-digest/samples/slow034-order-by-Locktime-sum.txt",
   ),
...
#  }
# #############################################################################
my $output = `$trunk/bin/mariadb-query-digest $sample/slow041.txt >/dev/null 2>/tmp/mqd-warnings.txt`;
is(
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow042-show-all-host.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow032.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow048.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow050.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow051.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow052.txt",
   ),
   'Analysis for slow052 (Apdex and V/M)',
);

# #############################################################################
# Bug 821694: mariadb-query-digest doesn't recognize hex InnoDB txn IDs
# #############################################################################
ok(
   no_diff(
      sub {
      ...
      "t/mariadb-query-digest/samples/slow054.txt",
   ),
   'Analysis for slow054 (InnoDB_trx_id bug 821694)'
);

# #############################################################################
# Bug 924950: mariadb-query-digest --group-by db may crash profile report
# #############################################################################
ok(
   no_diff(
      sub { pt_query_digest::main(@args, $sample.'slow055.txt',
         qw(--group-by db)) },
      "t/mariadb-query-digest/samples/slow055.txt",
   ),
   'Analysis for slow055 (group by blank db bug 924950)'
);

# #############################################################################
# Bug 1082599: mariadb-query-digest fails to parse timestamp with no query
# #############################################################################
ok(
   no_diff(
      sub { pt_query_digest::main(@args, $sample.'slow056.txt') },
      "t/mariadb-query-digest/samples/slow056.txt",
   ),
   'Analysis for slow056 (no query bug 1082599)'
);

# #############################################################################
# Bug 1176010: mariadb-query-digest should know how to group quoted and unquoted
# database names
...
ok(
   no_diff(
      sub { pt_query_digest::main(@args, $sample.'slow057.txt',
         qw(--group-by db)) },
      "t/mariadb-query-digest/samples/slow057.txt",
   ),
...
# mariadb-query-digest doesn't distill LOAD DATA correctly 
# https://bugs.launchpad.net/percona-toolkit/+bug/984053
# mariadb-query-digest doesn't distill INSERT/REPLACE without INTO correctly
# #############################################################################
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow058.txt",
   ),
...
ok(
   no_diff(
      ...
      "t/mariadb-query-digest/samples/slow059_report01.txt"
   ),
