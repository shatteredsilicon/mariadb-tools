...
This tool assists in the creation of partitions in regular intervals. It
...
Diagram of the \'startof\' operator for timespec `-1q startof`, given
...
The adding of partitions is not done blindly. This will only add new
