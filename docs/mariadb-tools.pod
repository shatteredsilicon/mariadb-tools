...
Diff MariaDB configuration files and server variables.

# =item pt-deadlock-logger

# Log MariaDB deadlocks.
...
# Find MariaDB tables and execute actions, like GNU find.
...
# Log MariaDB foreign key errors.

# =item pt-heartbeat

# Monitor MariaDB replication delay.
...
# Canonicalize and print MariaDB grants so you can effectively replicate, compare and version-control them.
...
# Make a MariaDB slave server lag behind its master.

# =item pt-slave-find

# Find and print replication hierarchy tree of MariaDB slaves.

# =item pt-slave-restart

# Watch and restart MariaDB replication after errors.
...
# Verify MariaDB replication integrity.

# =item pt-table-sync

# Synchronize MariaDB table data efficiently.
...
# Analyze MariaDB variables and advise on possible problems.
...
MariaDB Tools v1.0.0 released 2019-08-30
